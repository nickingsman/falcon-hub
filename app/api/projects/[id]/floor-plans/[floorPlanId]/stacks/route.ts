...
export async function GET(_request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json(await toStackResponses(supabase, data as FloorPlanStackRow[]));
  } catch (error) {
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const [response] = await toStackResponses(supabase, [data as FloorPlanStackRow]);
